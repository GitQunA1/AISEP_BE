...
builder.Services.AddScoped<ISystemTermService, SystemTermService>();
...
builder.Services.AddScoped<IDueDiligenceTemplateService, DueDiligenceTemplateService>();
builder.Services.AddScoped<IIndustryOptionService, IndustryOptionService>();
builder.Services.AddScoped<IStageOptionService, StageOptionService>();
