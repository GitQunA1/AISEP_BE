...
namespace AISEP.DAL.Migrations
{
    ...
    [Migration("20260506092654_AddDealInvestmentFields")]
    partial class AddDealInvestmentFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AISEP.DAL.Entities.DueDiligenceTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("due_diligence_templates", (string)null);
                });
            ...
            modelBuilder.Entity("AISEP.DAL.Entities.ProjectScorecard", b =>
                {
                    b.Property<int>("ProjectId")
                        .HasColumnType("integer");

                    b.Property<int>("BarrierToEntry")
                        .HasColumnType("integer");

                    b.Property<decimal?>("CalculatedScore")
                        .HasColumnType("decimal(6,2)");

                    b.Property<int>("CurrentTraction")
                        .HasColumnType("integer");

                    b.Property<bool>("HasTechnicalCofounder")
                        .HasColumnType("boolean");

                    b.Property<int>("IPProtection")
                        .HasColumnType("integer");

                    b.Property<int>("MarketGrowth")
                        .HasColumnType("integer");

                    b.Property<int>("ProductReadiness")
                        .HasColumnType("integer");

                    b.Property<int>("RunwayMonths")
                        .HasColumnType("integer");

                    b.Property<int>("TargetMarketSize")
                        .HasColumnType("integer");

                    b.Property<int>("TeamExperience")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("project_scorecards", (string)null);
                });
            ...
            modelBuilder.Entity("AISEP.DAL.Entities.ScorecardWeightConfig", b =>
                {
                    ...
                    b.Property<decimal>("MarketWeight")
                        .HasColumnType("decimal(5,2)");
                    ...
                    b.Property<decimal>("TractionWeight")
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("AISEP.DAL.Entities.SystemTerm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("system_terms", (string)null);
                });
            ...
            modelBuilder.Entity("AISEP.DAL.Entities.UserReport", b =>
                {
                    ...
                    b.HasIndex("ReporterId", "BookingId", "Status");
            ...
            modelBuilder.Entity("AISEP.DAL.Entities.ProjectScorecard", b =>
                {
                    b.HasOne("AISEP.DAL.Entities.Project", "Project")
                        .WithOne("Scorecard")
                        .HasForeignKey("AISEP.DAL.Entities.ProjectScorecard", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AISEP.DAL.Entities.UserReport", b =>
                {
                    ...
                    b.HasOne("AISEP.DAL.Entities.User", "ResolvedBy")
