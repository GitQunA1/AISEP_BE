...
{
    public partial class AddSystemCommissionConfigsAndBookingSnapshot : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldPercent = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    NewPercent = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_system_commission_change_logs_system_commission_configs_SystemCommissionConfigId",
